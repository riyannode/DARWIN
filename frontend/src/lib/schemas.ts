...
export const agentSchema = z.object({
  mode: z.string(), state: z.string(), emergencyStop: z.boolean(), nextRunAt: z.string().nullable().optional(), mandate: z.object({ version: z.string(), assets: z.string(), entryRules: z.string(), sizingRules: z.string(), exitRules: z.string(), allowedSymbols: z.array(z.string()), maxOrderNotional: z.string(), maxOpenActionableIntents: z.number(), createdAt: z.string() }).nullable(), latestDecision: z.object({ id: z.string(), state: z.string(), decision: z.record(z.string(), z.unknown()).nullable(), rationale: z.string().nullable(), startedAt: z.string(), completedAt: z.string().nullable(), mandateVersion: z.string().nullable(), budgetVersion: z.string().nullable() }).nullable(),
});
